<template>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 d-flex justify-content-end align-items-center">
              ...
              <div v-else id="wallet-holder" class="d-flex justify-content-end">
                ...
                <div class="d-sm-flex d-none align-items-center me-3">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu" style="background-color: #06262D;">
                    ...
                    <hr class="hr-game-plat d-flex d-sm-none w-75 mx-auto">
                    <li class="d-flex d-sm-none mb-2">
                      <img class="p-2 br-8 mx-2 logo-bg-green-light" height="35px" width="35px"
                        src="/images/game-platform/diamond.png" alt="">
                      <p class="text-grey my-auto">245,441</p>
                    </li>
                    <li class="d-flex d-sm-none">
                      <img class="p-2 br-8 mx-2 logo-bg-green-light" height="35px" width="35px"
                        src="/images/game-platform/soul.png" alt="">
                      <p class="text-grey my-auto">76,183</p>
                    </li>
                  </ul>
                </div>
              </div>
  ...
  <div class="modal-mask w-100" v-if="isModalVisible">
    <div class="row w-100">
      <div class="col-12 px-0 mx-auto">
        <div class="modal-wrapper w-100 mx-auto" style="max-width: 800px">
                    ...
                    <div class="row g-2 d-flex justify-content-between mx-auto">
                      <div class="col-lg-6 align-items-center">
                        <div class="card p-2 flex-row d-flex" style="background-color: #1C3D45;">
                          ...
                          <div class="my-auto">
                            <p class="text-white pb-1 my-0 fw-bold fs-6">Golden Trophy</p>
                      ...
                      <div class="col-lg-6 align-items-center">
                        <div class="card p-2 flex-row d-flex" style="background-color: #1C3D45;">
                          ...
                          <div class="my-auto">
                            <p class="text-white pb-1 my-0 fw-bold fs-6">Thunder Badge</p>
                            <p class="text-grey my-0 small-text">2024/03/11</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6 align-items-center">
                        <div class="card p-2 flex-row d-flex" style="background-color: #1C3D45;">
                          ...
                          <div class="my-auto">
                            <p class="text-white pb-1 my-0 fw-bold fs-6">Sacred Ring</p>
                            <p class="text-grey my-0 small-text">2024/03/11</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6 align-items-center">
                        <div class="card p-2 flex-row d-flex" style="background-color: #1C3D45;">
                          ...
                          <div class="my-auto">
                            <p class="text-white pb-1 my-0 fw-bold fs-6">Rock Medal</p>
                            <p class="text-grey my-0 small-text">2024/03/11</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col">
                    <div class="d-flex justify-content-between">
                      <div class="d-flex align-items-center">
                        <img src="/images/game-platform/latest-news-2.png" class="rounded me-2" height="32" width="32">
