<template>
  <div class="container-fluid d-flex p-0 game-layout" id="common-shop-layout">
...
useHead({
  title: "The Common Shop - Soakverse P2E",
});
...
<style lang="scss">
#common-shop-layout {
  background-image: url("/images/p2e/common-shop.webp");
