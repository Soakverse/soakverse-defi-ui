...
export class SW_PlayerActionsContainer extends Phaser.GameObjects.Container {
    ...
    constructor(scene: SW_BaseScene, x: number, y: number) {
        ...
        this.interactButton = this.scene.add.image(this.runButton.x - this.runButton.width - 16, this.height * 0.5 - 24, "interactButtonMobile").setOrigin(1, 1);
        this.interactButton.setInteractive();
        this.interactButton.on(Phaser.Input.Events.POINTER_DOWN, this.onInteractButtonPressed, this);
