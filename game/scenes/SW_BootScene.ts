...
import arrowFocusDialogueOption from '@/game/assets/ui/dialogues/arrowFocusDialogueOption.png';
...
export default class SW_BootScene extends SW_BaseScene {
  ...
  public preload(): void {
    ...
    this.load.image('arrowFocusDialogueOption', arrowFocusDialogueOption);
  }
  ...
  private preloadMenuAssets(): void {
    ...
    this.load.image(
      ...
      '/game/assets/ui/dialogueChoicesBackground.png'
    );
    this.load.image(
