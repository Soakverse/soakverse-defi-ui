...
import soakemonNFTAbi from './abi/soakemonNFT.json';
...
export const soakemonSmartContract: SmartContractDefinition = {
  address: '0xa9c2f9d4ec1548adc6f18712457fe2d588718493',
  abi: soakemonNFTAbi.abi,
  name: 'Soakemon By Soakverse',
  ticker: 'SOAKEMON',
  chainId: 8453,
};
